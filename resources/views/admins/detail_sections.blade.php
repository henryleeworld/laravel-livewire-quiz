        ...
        <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
            <div class="mx-auto">
                <div class="flex justify-between items-center py-4">
                    <a href="{{route('questions.create',$section->id)}}" class="tracking-wide font-bold rounded border-2 border-blue-500 hover:border-blue-500 bg-blue-500 text-white hover:bg-blue-600 transition shadow-md py-2 px-6 items-center">{{ __('Create a Question') }}</a>
                                ...
                                <table class="min-w-full divide-y divide-gray-200">
                                    ...
                                    <tbody class="bg-white divide-y divide-gray-200">
                                        ...
                                        <tr>
                                            ...
                                            <td class="px-6 py-4 ">
                                                <div class="text-sm text-gray-900">{{ $section->is_active === '1'  ? __('Active') : __('Not Active') }}</div>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="px-6 py-4">
                                ...
                                <table class="min-w-full divide-y divide-gray-200">
                                    ...
                                    <tbody class="capitalize bg-white divide-y divide-gray-200">
                                        ...
                                        <tr class="hover:bg-green-100">
                                            ...
                                            <td class="px-6 py-1">
                                                <div class="text-sm text-gray-900">{{ $question->is_active === '1'  ? __('Yes') : __('No') }}</div>
                                            </td>
