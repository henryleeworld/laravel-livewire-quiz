        ...
        <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
            <div class="mx-auto">
                <div class="flex justify-between items-center py-4">
                    <a href="{{route('quiz.create')}}" class=" tracking-wide font-bold rounded border-2 border-blue-500 hover:border-blue-500 bg-blue-500 text-white hover:bg-blue-600 transition shadow-md py-1 px-6 items-center">{{ __('Take a New Quiz') }}</a>
                                ...
                                <table class="min-w-full divide-y divide-gray-200">
                                    ...
                                    <tbody class="capitalize bg-white divide-y divide-gray-200">
                                        ...
                                        <tr class="hover:bg-green-100">
                                            ...
                                            <td class="px-6 py-1">
                                                <div class="text-sm text-gray-900">{{ $quiz->completed ? __('Completed') : __('Not Completed') }}</div>
                                            </td>
                                            <td class="px-6 py-1">
                                                <div class="text-sm ">
    ...
    <script>
        const chart = new Chartisan({
            ...
            loader: {
                ...
                type: 'bar',
                textColor: '#ffff00',
                text: "{{ __('Loading some chart data...') }}",
            },
